...
public class MainPage{
    ...
    public MainPage(){
        ...
        lb1.setFont(new Font("Goudy Old Style", 3, 150));
        lb1.setForeground(new Color(240, 120, 240));
        lb1.setText("T");
        
        lb2.setFont(new Font("Goudy Old Style", 3, 150));
        lb2.setForeground(new Color(126, 251, 204));
        lb2.setText("E");

        lb3.setFont(new Font("Goudy Old Style", 3, 150));
        lb3.setForeground(new Color(72, 240, 237));
        lb3.setText("T");

        lb4.setFont(new Font("Goudy Old Style", 3, 150));
        lb4.setForeground(new Color(255, 189, 0));
        lb4.setText("R");

        lb5.setFont(new Font("Goudy Old Style", 3, 150));
        lb5.setForeground(new Color(149, 125, 173));
        lb5.setText("I");

        lb6.setFont(new Font("Goudy Old Style", 3, 150));
        lb6.setForeground(new Color(223, 255, 0));
        lb6.setText("S");

        lb7.setFont(new Font("Goudy Old Style", 3, 90));
        lb7.setForeground(new Color(248, 152, 164));
        lb7.setText("Murati");

        bt1.setFont(new Font("Goudy Old Style", 3, 30));
        bt1.setText("Start");

        bt2.setFont(new Font("Goudy Old Style", 3, 30));
        bt2.setText("Option");

        bt3.setFont(new Font("Goudy Old Style", 3, 30));
        bt3.setText("About");

        bt4.setFont(new Font("Goudy Old Style", 3, 30));
        bt4.setText("Exit");
        ...
        fr.getContentPane().add(pn1, java.awt.BorderLayout.CENTER);
